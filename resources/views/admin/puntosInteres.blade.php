...
@section('content')
<div class="xl:w-1/3 md:w-1/2 p-4 d-flex flex-wrap" style="gap:3em">
    <div class="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden w-32" style="width: 30%">
        ...
        <div class="p-4">
            ...
            <p class="text-gray-600 font-light text-md mb-3">
                Tiene el suelo de parqué por que era el despacho de no se quienk 3iufg ifg3 ii34f 3ijhfb ihbfih34bf hi
            ...
            <div class="flex items-center mt-2 flex-row-reverse">
                <button type="button" class="btn btn-success rounded-circle flex editButton"><i class="fa-solid fa-pen-to-square"></i></button>
            </div>
        </div>    
    </div>
